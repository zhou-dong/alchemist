                ...
                <Container maxWidth="lg" sx={{ flex: 1, py: 4 }}>
                    <Box sx={{ mb: 4 }}>
                        ...
                        <Typography variant="h6" component="p" color="text.secondary" sx={{ mb: 4 }}>
                            Master hash-based data structures and collision resolution techniques
                        </Typography>
                    </Box>
                    
                    <Grid container spacing={3}>
                        {hashTableProblems.map((problem, index) => (
...
export default HashTableCategory;
