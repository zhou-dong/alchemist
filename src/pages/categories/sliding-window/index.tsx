                ...
                <Container maxWidth="lg" sx={{ flex: 1, py: 4 }}>
                    <Box sx={{ mb: 4 }}>
                        ...
                        <Typography variant="h6" component="p" color="text.secondary" sx={{ mb: 4 }}>
                            Master the sliding window technique for subarray and substring problems
                        </Typography>
                    </Box>
                    
                    <Grid container spacing={3}>
                        {slidingWindowProblems.map((problem, index) => (
...
export default SlidingWindowCategory;
