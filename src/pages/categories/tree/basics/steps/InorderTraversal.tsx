...
const InorderTraversal = ({ containerRef, canvasRef, setStep }: StepProps) => {
    ...
    return (
        <Box>
            <Stack spacing={6}>
                <Basics currentStep={Step.INORDER_TRAVERSAL} />
                <StepsIndicator currentStep={Step.INORDER_TRAVERSAL} />
