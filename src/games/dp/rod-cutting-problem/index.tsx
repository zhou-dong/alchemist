...
import { addHelperStyles, updateTable, nonCorrect, isLastCell, createNewTableStyles, getLastCell, getNextPoint } from "./update";
...
const buildData = () => {
    shuffle(items);
    const table = createTableMatrix(items, totalLength);
    const tableStyles = createTableStyles(items, totalLength);
    const buttons = createButtons(items, totalLength);
    const buttonsStyles = createButtonsStyles(items, totalLength);
    const comparedTable = createComparedTable(items, totalLength);
