...
export const landStyle: React.CSSProperties = { backgroundColor: yellow[800], color: "#000", border: "2px solid lightgrey" };
export const waterStyle: React.CSSProperties = { backgroundColor: blue[400], color: "#fff", border: "2px solid lightgrey" };
