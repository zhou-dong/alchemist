...
export default class LRUCache<T> {
    ...
    private afterInit(scene: THREE.Scene) {
        const self = this;
        new FontLoader().load(FONT_LOCATION, function (font) {
    ...
    private createDoublyLinkedList(font: Font, scene: THREE.Scene) {
    ...
    private createDoublyLinkedListNodeStyles(font: Font): NodeStyles {
    ...
    private createHashMap(font: Font, scene: THREE.Scene) {
    ...
    private createHashMapNodeStyles(font: Font): NodeStyles {
