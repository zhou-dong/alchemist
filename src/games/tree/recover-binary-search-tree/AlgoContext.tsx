...
const AlgoContext = React.createContext<{
    ...
    setErrorOne: React.Dispatch<React.SetStateAction<TreeNode<number> | undefined>>,
    setErrorTwo: React.Dispatch<React.SetStateAction<TreeNode<number> | undefined>>,
}>({
    state: State.Typing,
    setState: () => { },
...
export const AlgoContextProvider: React.FC<{
    ...
    const [errorOne, setErrorOne] = React.useState<TreeNode<number>>();
    const [errorTwo, setErrorTwo] = React.useState<TreeNode<number>>();
