export const title = "Sliding Window Median";
...
export const medianSlidingWindow = `class DualHeap {
...
- For examples, if arr = [3,4,5], the median is 4.
- For examples, if arr = [2,3,4,5], the median is (3 + 4) / 2 = 3.5.
